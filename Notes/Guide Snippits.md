...
## Replacement/Custom Pedals for the Original Controller<br/>
What You Need:
* Three Pedal (see options below)
...
* Existing Controller Pedals (USB or modularized)
* 3D Printing Pedals
* Buying go-kart and/or industrial pedals, making adjustments
Input Adapted Pedals or DIY Pedals 
...
## Using Pre-Existing Pedal Controllers
This is covered in [section 4B on Adapted Controllers](http://github.com/quizerno/Steel-Battalion-Entry-Guide/blob/main/4B-Adapted%20Controllers.md)
...
**Pedals for a Custom Controller or Emulator**<br/>
