...
I have attached a configuration for HOTAS provided by Gnomp. These are specifically built for the Gunfighter MCG and STECs
...
For Step 2, instead of replacing the whole file, you can merely add the following lines.
```
